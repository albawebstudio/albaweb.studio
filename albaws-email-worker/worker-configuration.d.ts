/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config wrangler.jsonc` (hash: c516c2c35be18327703896ccc1f32551)
...
declare namespace Cloudflare {
	...
	interface Env {
		EMAIL: SendEmail;
		EMAIL_RECIPIENT: "support@albawebstudio.com";
		EMAIL_SENDER: "support@albawebstudio.com";
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "EMAIL_RECIPIENT" | "EMAIL_SENDER">> {}
}
